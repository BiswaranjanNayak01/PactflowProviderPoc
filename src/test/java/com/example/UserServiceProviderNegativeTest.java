...
public class UserServiceProviderNegativeTest {

    private static WireMockServer wireMockServer;

    @BeforeAll
    static void startProvider() {
        wireMockServer = new WireMockServer(8088); // Start on port 8080
        ...
        wireMockServer.stubFor(
                get(urlPathEqualTo("/user/1"))
                        .willReturn(aResponse()
                                ...
                                .withBody("{\"id\": 1, \"name\": \"John Doe error\"}"))
        );
    }
    ...
    void setUp(PactVerificationContext context) {
        ...
        context.setTarget(new HttpTestTarget("localhost", 8088));
    }
